    ...
    <Column gap="xl" style={{ alignItems: 'center' }}>
      ...
      <Column style={{ width: '100%', maxWidth: '1000px', textAlign: 'left' }}>
        ...
        <Text variant="body-default-l" style={{ marginTop: '16px' }}>
          I conducted a detailed wind load analysis on a stage cover using Autodesk CFD and SolidWorks. The report clarified discrepancies between client tests and CFD results by evaluating wind forces from 10–60 Km/h, highlighting a 19% variance in safety margins, and recommending improvements in rope selection and secure mounting.
        </Text>
          ...
          <Column gap="xl" style={{ marginTop: '16px' }}>
            ...
            <Text variant="body-default-l">
              <ul style={{ listStyleType: 'disc', margin: '0 0 0 20px', padding: 0 }}>
                <li>
                  Performed comprehensive wind load analysis using Autodesk CFD and SolidWorks.
                </li>
                <li>
                  Identified a 19% variance in safety margins, underscoring the need for design improvements.
                </li>
                <li>
                  Delivered actionable recommendations on rope selection and secure mounting.
                </li>
              </ul>
            </Text>
          </Column>
