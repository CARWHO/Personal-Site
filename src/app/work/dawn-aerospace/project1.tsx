    ...
    <Column gap="xl">
      ...
      {isMobile ? (
        ...
        <Column>
          ...
          <Text variant="body-default-l">
            At Dawn Aerospace, I led the Feedline Characterization project, which aimed
            to develop a deeper understanding of the feedline’s thermal and electrical
            performance.
          </Text>
        </Column>
      ) : (
      ...
      {open && (
        <Column gap="xl">
          ...
          <Column style={{ width: "100%" }}>
            ...
            <Text variant="body-default-l">
              ...
              >
                ...
                <li>
                  <strong>Sensor Comparison:</strong>
                  <br />
          ...
          {/* TITLE: "To achieve these objectives..." */}
          ...
          {isMobile ? (
            // ---- MOBILE: single column, no big transforms ----
            <Column>
              <Text variant="body-default-l">
                <ul style={{ paddingLeft: "1em" }}>
                  <li>
                    <strong>Test Jig Development:</strong>
                    <br />
                    Designed and built a custom test jig baseplate, incorporating 3D-printed components. All parts were certified for operation within a vacuum chamber.
                  </li>
                  <li style={{ marginTop: "16px" }}>
                    <strong>Safe Integration in Vacuum Environment:</strong>
                    <br />
                    Engineered and produced specialized cables designed to safely interface within the vacuum chamber.
                  </li>
                  <li style={{ marginTop: "16px" }}>
                    <strong>Software Development &amp; Systems Integration:</strong>
                    <br />
                    Developed a bespoke GUI to interface with feedline peripherals (thruster, tank electronics) and the main controller node. Set up a local YAMCS server to streamline data collection.
                  </li>
                </ul>
              </Text>
            </Column>
          ...
          {isMobile ? (
            ...
            <Column>
              <Heading variant="display-strong-m" style={{ marginBottom: "24px", marginTop: "24px" }}>
              ...
              <Text variant="body-default-l" style={{ marginBottom: "24px" }}>
                <ul>
                  <li style={{ marginBottom: "16px" }}>
                    ...
                    <br />
                    <strong>Key Insight:</strong> Correlating heater activation with fluid temperature rise validates the heat transfer analysis.
                  </li>
                  <li>
                    <strong>Temperature Losses Along the Feedline</strong>
                    <br />
                    This plot compares input and output temperatures at multiple points along the feedline.
                    <br />
                    <strong>Key Insight:</strong> A progressive drop in temperature indicates significant thermal losses, guiding design improvements.
                  </li>
                </ul>
              </Text>
            </Column>
          ) : (
            // ---- DESKTOP: original row #4
            <Column
              horizontal="space-between"
              gap="l"
              style={{ flexDirection: "row", alignItems: "flex-start" }}
              ...
              <Text variant="body-default-l">
                <ul>
                  <li style={{ marginBottom: "16px" }}>
                    ...
                    <br />
                    Scatter points from thermocouples vs. RTDs show consistency, with minor deviations.
                  </li>
                  <li>
                    <strong>Heater Power Consumption</strong>
                    <br />
                    Voltage, current, and power usage are tracked over time, aligning jumps with heater activation.
                  </li>
                </ul>
              </Text>
            </Column>
          ) : (
            // ---- DESKTOP: original row #5
            <Column
              horizontal="space-between"
              gap="l"
              style={{ flexDirection: "row", alignItems: "flex-start" }}
            >
              <Column style={{ width: "40%", gap: "10px" }}>
                ...
                <img
                  ...
                  style={{
                    width: "120%",
                    transform: "translateY(0px) translateX(-103px)",
                    borderRadius: "12px",
                    objectFit: "cover",
                  }}
                />
                ...
                <Text variant="body-default-l">
                  <ul>
                    <li>
                      ...
                      <br />
                      <strong>Key Insight:</strong> Minor deviations highlight potential calibration offsets or response time differences, guiding future sensor selection and calibration practices.
                    </li>
                    <li style={{ marginTop: "30px" }}>
                      ...
                      <br />
                      <strong>Key Insight:</strong> By tracking real-time power usage, we can evaluate the efficiency of the heating system and ensure safe operating parameters.
                    </li>
                  </ul>
                </Text>
              </Column>
